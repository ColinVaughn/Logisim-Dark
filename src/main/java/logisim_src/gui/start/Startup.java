...
import logisim_src.LogisimMain;
import logisim_src.file.LoadFailedException;
import logisim_src.file.Loader;
import logisim_src.gui.main.Print;
import logisim_src.gui.menu.LogisimMenuBar;
import logisim_src.gui.menu.WindowManagers;
import logisim_src.prefs.AppPreferences;
import logisim_src.proj.Project;
import logisim_src.proj.ProjectActions;
import logisim_src.util.LocaleManager;
import logisim_src.util.MacCompatibility;
	...
	public static Startup parseArgs(String[] args) {
		...
		for (int i = 0; i < args.length; i++) {
			...
			if (arg.equals("-tty")) {
				...
				System.out.println(LogisimMain.VERSION_NAME); //OK
				return null;
